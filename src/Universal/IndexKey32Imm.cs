...
namespace Universal
{
    public class IndexKey32Imm : IIndex //IIndexImmutable<Tkey> where Tkey : IComparable
    {
        ...
        public IndexKey32Imm(Func<object, int> keyProducer, Func<Stream> streamGen)
        {
